...
class ConvertToPostFixTest {
	...
	// Test algorithms ability to handle same precedent symbols. Should be interpreted left to right.
	@Test
	...
	// Test Algorithm's ability to properly output exponential symbols and test the order at which they are placed.
	@Test
	void NestedExponentialTest(){
		String infix = "a^b^c";
		assertEquals(" a b c^^", LinkedStack.convertToPostfix(infix));
	}
 
	// Test algorithm's ability to ignore non-math symbols and handle many different operands at once.
	@Test
	...
	//Test algorithm's ability to handle different precedent operators.
	@Test
	...
	//Test algorithm's ability to handle multiple parenthesis in a single equation.
	@Test
	void DoubleParenthesisTest() {
		String infix = "(a+b)/(c-d)";
		assertEquals(" a b+ c d-/", LinkedStack.convertToPostfix(infix));
	}
	//Test algorithm's ability to handle nested parenthesis
	@Test
	void NestedParenthesisTest(){
